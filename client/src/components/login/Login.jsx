...
export default function Login(){
    ...
    return(
        <section>
            ...
            <input type="email" id="email" name="email" placeholder="email@domain.com" onBlur={handleTouch}
            ...
            <input type="submit" className="btn submit" value="Login"  disabled={isDisabled}/>
